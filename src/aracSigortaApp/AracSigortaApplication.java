...
import aracSigorta_deneme.Vehicle;
...
public class AracSigortaApplication {
    ...
    // 1.Main method olusturalim
    public static void main(String[] args) {
   // 2. uygulmayi baslatan bir method olusturalim
        start();
    }

    // 3.Method olusturalim
    public static void start() {
    //4. kullanıcıdan bilgi alalim
        Scanner input=new Scanner(System.in);


   //5. tekrar tekrar menü gosterilsin
        boolean isAgain;
        do {
            ...
            //6.tarife donemi dogru girilirse isleme devam et hatali ise uyari verip tekrar forma gonderme islemi yap
            if (donem==1||donem==2){
                //7. bir arac class'i olusturalim
                //12. bir arac objesi olusturalim
